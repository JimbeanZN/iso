...
namespace Iso.Api.Controllers
{
  ...
  {
    private readonly IBaseService<IsoCurrency> _currenciesService;

    public CurrenciesController(IBaseService<IsoCurrency> currenciesService)
    {
    ...
    {
      return await _currenciesService.GetRelatedEntities(alpha3Code);
    }
  }
}