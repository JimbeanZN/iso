...
namespace Iso.Api.Controllers
{
  ...
  {
    private readonly IBaseService<IsoCountry> _countryService;

    public CountriesController(IBaseService<IsoCountry> countryService)
    {
    ...
    {
      return await _countryService.GetRelatedEntities(alpha3Code);
    }
  }
}